...
int main()
{
    string data_login[2][3]={{"admin","admin","Admin"},{"mahasiswa","andhika","123"}};  
    string username, password, level;
    string command,name,inName, inPassword,registerName, registerPassword;
    STUDENT o[10];
    int i=0,ch,j,NIM;
    ...
    cout << "      Silahkah memilih opsi dibawah       \n";  
    cout << "==========================================\n\n";
    cout << "       Anda Login Sebagai Mahasiswa       \n";  
    cout << "==========================================\n\n";
    cout << "                     MENU                 \n\n";
